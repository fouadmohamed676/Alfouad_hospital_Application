...
class HospitalDetailsAdapter(private val hospital_list: List<HospitalDetailsModel>): RecyclerView.Adapter<HospitalDetailsAdapter.HospitalViewHolder>(){
    ...
    inner class HospitalViewHolder(val binding: ItemNameBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(hospitalDetails: HospitalDetailsModel){
