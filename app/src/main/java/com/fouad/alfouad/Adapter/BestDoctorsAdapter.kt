...
class BestDoctorsAdapter (private val context: Context, private val dataList: List<DoctorHospital>) :
    RecyclerView.Adapter<BestDoctorsAdapter.DoctorViewHolder>() {
    ...
    inner class DoctorViewHolder(binding: DoctorsItemBinding) : RecyclerView.ViewHolder(binding.root) {
